...
leukemia_blasso <- blasso(X = leukemia_design_std, y = leukemia$class, T = 500, thin = NULL)
#?blasso
#boxplot(leukemia_blasso$beta, horizontal = TRUE, las = 1)
#abline(v=0, lty = 1)

hist(rowSums(abs(leukemia_blasso$beta)), probability = TRUE)
