...
Vi ser herunder et scree plot, hvor vi ser en grafisk afbildning af egenværdierne.
...
nscree_carcass
```
Igen peger alt mod 3 faktorer. Vi regner eigenværdierne ud.
```{r, echo=FALSE }
...
```
```{r}
factanal(carcass, factors = 3, rotation = "none", na.action = na.omit)
```
 ---- Her skal der kloges i "uniqueness" "loadings" og "chi-square-tes" --- 
